...
export const SummaryCards: React.FC<SummaryCardsProps> = ({ onMonthlyComparisonClick }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {cards.map((card, index) => (
          <motion.div
            ...
            className={`relative overflow-hidden ${card.bgClass} p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow`}
          >
